 ...
 */
final class Version20190322172724 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE carousel_presentation_map (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, presentation_id INTEGER NOT NULL, carousel_id INTEGER NOT NULL, twig_key VARCHAR(20) NOT NULL)');
        ...
        $this->addSql('DROP INDEX UNIQ_3A23C0DCC1CE5B98');
        $this->addSql('DROP INDEX UNIQ_3A23C0DC5DA0FB8');
        $this->addSql('CREATE TEMPORARY TABLE __temp__presentation_carousel_map AS SELECT id, template_id, carousel_id, twig_key FROM presentation_carousel_map');
        $this->addSql('DROP TABLE presentation_carousel_map');
        $this->addSql('CREATE TABLE presentation_carousel_map (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, template_id INTEGER NOT NULL, carousel_id INTEGER NOT NULL, twig_key VARCHAR(20) NOT NULL COLLATE BINARY, CONSTRAINT FK_3A23C0DC5DA0FB8 FOREIGN KEY (template_id) REFERENCES template (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_3A23C0DCC1CE5B98 FOREIGN KEY (carousel_id) REFERENCES carousel (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO presentation_carousel_map (id, template_id, carousel_id, twig_key) SELECT id, template_id, carousel_id, twig_key FROM __temp__presentation_carousel_map');
        $this->addSql('DROP TABLE __temp__presentation_carousel_map');
