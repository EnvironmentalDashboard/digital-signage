 ...
 */
final class Version20190421200804 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE google_slides (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, presentation_id VARCHAR(44) NOT NULL, data CLOB NOT NULL --(DC2Type:json)
        )');
        ...
        $this->addSql('CREATE TABLE carousel_presentation_map (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, presentation_id INTEGER NOT NULL, carousel_id INTEGER NOT NULL, template_key VARCHAR(20) NOT NULL COLLATE BINARY, CONSTRAINT FK_72A9D661AB627E8B FOREIGN KEY (presentation_id) REFERENCES presentation (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_72A9D661C1CE5B98 FOREIGN KEY (carousel_id) REFERENCES carousel (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO carousel_presentation_map (id, presentation_id, carousel_id, template_key) SELECT id, presentation_id, carousel_id, template_key FROM __temp__carousel_presentation_map');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE google_slides');
        $this->addSql('DROP INDEX IDX_3A06AC3DF6D1A74B');
        $this->addSql('DROP INDEX IDX_3A06AC3D60A20B48');
        $this->addSql('DROP INDEX IDX_3A06AC3DBEFA6858');
        $this->addSql('CREATE TEMPORARY TABLE __temp__button AS SELECT id, controller_id, trigger_frame_id, on_display_id, twig_key FROM button');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__carousel_presentation_map AS SELECT id, presentation_id, carousel_id, template_key FROM carousel_presentation_map');
        $this->addSql('DROP TABLE carousel_presentation_map');
        $this->addSql('CREATE TABLE carousel_presentation_map (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, presentation_id INTEGER NOT NULL, carousel_id INTEGER NOT NULL, template_key VARCHAR(20) NOT NULL)');
        $this->addSql('INSERT INTO carousel_presentation_map (id, presentation_id, carousel_id, template_key) SELECT id, presentation_id, carousel_id, template_key FROM __temp__carousel_presentation_map');
        $this->addSql('DROP TABLE __temp__carousel_presentation_map');
        $this->addSql('CREATE INDEX IDX_72A9D661AB627E8B ON carousel_presentation_map (presentation_id)');
        $this->addSql('CREATE INDEX IDX_72A9D661C1CE5B98 ON carousel_presentation_map (carousel_id)');
