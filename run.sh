...
then
	# prod env:
	docker run -dit -p 5000:80 -p 5001:8080 --restart always -v /var/www/uploads/digital-signage:/var/www/html/public/uploads -e APP_ENV=prod -e APP_DEBUG=0 --name PROD_DS digital-signage
else
	# dev env:
