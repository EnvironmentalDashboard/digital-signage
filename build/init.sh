...
apt-get update
apt-get -qq -y install apt-utils tzdata apache2 php libapache2-mod-php php-cli php-mbstring php-xml curl php-curl sqlite php-sqlite3 php-xdebug php-gd unzip
